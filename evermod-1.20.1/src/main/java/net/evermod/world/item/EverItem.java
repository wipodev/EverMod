...
public class EverItem extends Item {
  // Registro interno para el evento BuildCreativeModeTabContentsEvent
  public static final Map<Item, EverCreativeTab> TAB_MAP = new ConcurrentHashMap<>();
  ...
  public static class Properties extends Item.Properties implements Supplier<Item> {
    private EverCreativeTab everTab;
    ...
    @Override
    public Item get() {
      EverItem item = new EverItem(this);
      if (this.everTab != null) {
        TAB_MAP.put(item, this.everTab);
      }
      return item;
    }
  }
